...
<div class="vote-box content<?= (!$extended || $inline) ? ' vote-box--compact' : '' ?><?= $inline ? ' vote-box--inline' : '' ?>">
    ...
    <div class="tags"><?= WikiTaglist::widget(['wiki' => $model]) ?></div>
    <?php if ($extended): ?>
        <div class="people"><span>Written by:</span> <?= $model->creator->rankLink ?></div>
        <?php if ($model->updater): ?>
            <div class="people"><span>Updated by:</span> <?= $model->updater->rankLink ?></div>
        <?php endif ?>
