...
<div class="wrapper">
    <div class="flex-center">
        ...
        <p class="guide-link">Check the <a href="https://yiisoft.github.io/docs/guide.html">guide in progress to learn more</a>.</p>
        ...
        <ul class="mini-footer">
            ...
            <li>
                <span>
                    <a href="<?= Url::to('donate') ?>" target="_blank">Donate</a>
                </span>
            </li>
            <li>
                <span>
