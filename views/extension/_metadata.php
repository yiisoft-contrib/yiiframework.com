...
<div class="vote-box content">
    ...
    <div class="version"><span>Yii Version:</span> <?= empty($model->yii_version) ? 'Unknown (' . Html::a('update', ['extension/update', 'id' => $model->id]) . ')' : Html::encode($model->yii_version) // TODO permission ?></div>
    <div class="people"><span>License:</span> <?= $model->license_id ?></div>
