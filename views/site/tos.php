...
<div class="container style_external_links">
    <div class="content">
        ...
        <p>We do not collect personal information about you unless you voluntarily provide it to us or authorize us to
           collect it. We consider the following to be personal information: your name, email address, phone number,
           date of birth, job, personal interests, your e-mail address. We treat personal information confidentially.</p>

        <p>We do collect and track certain non-personally information, including but not limited to, user IP numbers and
        ...
        <p>We may use cookies to customize your use of the website and for other purposes to improve your use of the service,
           ...
           to automatically retrieve personal information from your computer without your knowledge.</p>
        ...
        <ol>
            ...
            <li>You remain solely responsible for the content that you posted. Furthermore, you agree to indemnify and hold
                harmless the owners of this website, its staff, and its subsidiaries. The owners of this website also reserve
                the right to reveal your identity (or any other related information collected on this service) in the event
                of a formal complaint or legal action arising from any situation caused by your use of this website.</li>
        </ol>

        <h2>Change of Policies</h2>

        <p>The above policies may change from time to time. YiiSoft will post those changes on this page.</p>
