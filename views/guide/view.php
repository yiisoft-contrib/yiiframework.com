            ...
            <div class="col-md-12 col-lg-11">
                ...
                <div class="prev-next clearfix">
                    ...
                    if (($prev = $section->getPrevSection()) !== null) {
                        $left = '<span class="fa fa-chevron-left" aria-hidden="true"></span> ';
                    ...
                    if (($next = $section->getNextSection()) !== null) {
                        $right = ' <span class="fa fa-chevron-right" aria-hidden="true"></span>';
                    ...
                    echo '<div class="text-center"><a href="#top">Go to Top <span class="fa fa-chevron-up" aria-hidden="true"></span></a></div>';
                    ?>
                </div>
